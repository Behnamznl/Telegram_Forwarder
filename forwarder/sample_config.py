...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "5029725DMp8djfRkn2Plcj8hhOwLkd5VxO8"  # API key obtained from BotFather
    ...
    FROM_CHATS = [-1001520628]  # List of chat id's to forward messages from
    TO_CHATS = [-10015284601]  # List of chat id's to forward messages to
